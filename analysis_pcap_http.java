...
class analysis_pcap_http{
	...
	public static void main(String[] args){
		...
		System.out.println("1:http_1080.pcap \n2:tcp_1081.pcap \n3:tcp1082.pcap");
		...
		if(z==1){
			...
			filename = "tcp_1081.pcap";	
		}else if(z==3){
			filename = "tcp_1082.pcap";
		}
		//String 
		//String 
		//String 
		
		String pcapFile = filename;
		...
		outputPacketInfo(theFlowPortNums,table, 3000); //takes all of the information and displays neatly, the first n transactions per flow
	...
	public static void outputPacketInfo(ArrayList<Integer>theFlowPortNums, long[][]table, int length){
		...
		for(int q = 0;q<theFlowPortNums.size();q++){
			...
			System.out.println();
			//System.out.println("Total outgoing bytes for entire flow: " + starting);
			System.out.println("Total outgoing packets for entire flow: " + i);
